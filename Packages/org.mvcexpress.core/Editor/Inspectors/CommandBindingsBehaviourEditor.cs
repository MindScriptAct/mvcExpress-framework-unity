...
{
    /// <summary>
    /// Custom inspector for CommandBindingsBehaviour that lists the runtime command-to-message bindings configured on the component.
    /// </summary>
    ...
    public sealed class CommandBindingsBehaviourEditor : UnityEditor.Editor
    {
        ...
        private const string HeaderIconPath = "Packages/org.mvcexpress.core/Editor/Icons/mvc_command_registry_icon.png";
