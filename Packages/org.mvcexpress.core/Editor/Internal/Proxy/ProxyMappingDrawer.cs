...
namespace mvcExpress.Editor.Core
{
    ...
    public class ProxyMappingDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            // 6. Permanent/Transient Badge (click to toggle)
            var lifecycleBadgeRect = new Rect(currentX + CHECKBOX_PADDING / 2, rect.y, CHECKBOX_WIDTH, rect.height);
            bool newTransientValue = MvcEditorUtility.DrawLifecycleBadge(lifecycleBadgeRect, isTransientProp.boolValue, "Proxy");
