...
namespace mvcExpress.Editor.Settings
{
    internal static class MvcExpressSettingsProvider
    {
        ...
        private const string PrefKeyMessagingGenericFoldout = "org.mvcexpress.core.settings.messaging.samples.generic";
        private const string PrefKeyMessagingPayloadFoldout = "org.mvcexpress.core.settings.messaging.samples.payload";
        private const string PrefKeyMessagingCustomFoldout = "org.mvcexpress.core.settings.messaging.samples.custom";
        ...
        private static void OnGUI()
        {
            ...
            var tab = EditorPrefs.GetInt("org.mvcexpress.core.settings.tab", 0);
            tab = GUILayout.Toolbar(tab, Tabs);
            tab = Mathf.Clamp(tab, 0, Tabs.Length - 1);
            EditorPrefs.SetInt("org.mvcexpress.core.settings.tab", tab);
