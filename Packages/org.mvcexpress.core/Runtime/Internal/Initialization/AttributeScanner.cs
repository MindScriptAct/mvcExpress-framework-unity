...
namespace mvcExpress.Internal.Initialization
{
    ...
    internal static class AttributeScanner
    {
        ...
        // the global cache. MonoBehaviour types are accepted alongside plain C# types - MvcFacade
        // resolves them to a scene instance (found or auto-created) at drain time, since they
