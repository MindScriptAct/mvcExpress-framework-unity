...
namespace mvcExpress.Internal.Interfaces
{
    ...
    public interface IModuleDependencyRegistrar
    {
        ...
        /// Must be completed by calling AsPermanent() or AsTransient() on the builder.
        /// </summary>
        ...
        /// <returns>True if the type is transient, false if permanent or not registered</returns>
        bool IsTransient(Type type);

        /// <summary>
        /// Unregisters a type from all containers (logic and view).
        /// For permanent types, throws an error (cannot be destroyed).
        /// For transient types, triggers command invalidation.
        /// </summary>
        /// <typeparam name="T">Type to unregister</typeparam>
        /// <exception cref="InvalidOperationException">
        /// Thrown if attempting to unregister a permanent dependency.
        /// Permanent dependencies cannot be destroyed during module lifetime.
        /// </exception>
        void Unregister<T>();
