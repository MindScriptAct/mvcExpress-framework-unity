...
namespace mvcExpress.Internal.Commands
{
    public sealed partial class MvcCommandProcessor
    {
        ...
        /// <summary>
        /// Binds a sync command to a message with one payload value. The command
            ...
            where TMessage : IMessage<T1>
        {
            ...
            ValidateCommandArity<TCommand, Command<T1>>();
        ...
        /// <summary>
        /// Binds an async command to a message with one payload value.
        /// </summary>
        public void BindCommandAsync<TCommand, TMessage, T1>(uint poolSize = 0)
            where TCommand : MvcCommandBase, new()
            where TMessage : IMessage<T1>
        {
            ValidateCommandArity<TCommand, CommandAsync<T1>>();
        ...
        /// <summary>
        /// Unbinds a sync command from a message with one payload value.
        ...
        /// <summary>
        /// Unbinds an async command from a message with one payload value.
        /// </summary>
        ...
        /// <summary>
        /// Runs a command directly without a message (one payload value, sync).
        ...
        /// <summary>
        /// Runs a command directly without a message (one payload value, async).
        /// Uses the centralized pool - creates with the default size (0) if not configured.
        /// </summary>
