...
namespace mvcExpress.Internal.Commands
{
    public sealed partial class MvcCommandProcessor
    {
        ...
        /// <summary>
        /// Binds a sync command to a message with three payload values. The command
            ...
            where TMessage : IMessage<T1, T2, T3>
        {
            ...
            ValidateCommandArity<TCommand, Command<T1, T2, T3>>();
        ...
        /// <summary>
        /// Binds an async command to a message with three payload values.
        /// </summary>
        public void BindCommandAsync<TCommand, TMessage, T1, T2, T3>(uint poolSize = 0)
            where TCommand : MvcCommandBase, new()
            where TMessage : IMessage<T1, T2, T3>
        {
            ValidateCommandArity<TCommand, CommandAsync<T1, T2, T3>>();
        ...
        /// <summary>
        /// Unbinds a sync command from a message with three payload values.
        ...
        /// <summary>
        /// Unbinds an async command from a message with three payload values.
        /// </summary>
        ...
        /// <summary>
        /// Runs a command directly without a message (three payload values, sync).
        ...
        /// <summary>
        /// Runs a command directly without a message (three payload values, async).
        /// Uses the centralized pool - creates with the default size (0) if not configured.
        /// </summary>
