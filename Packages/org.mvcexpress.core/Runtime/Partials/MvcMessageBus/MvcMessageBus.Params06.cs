...
namespace mvcExpress.Internal.Messaging
{
    public sealed partial class MvcMessageBus : IMessageBus, IDisposable
    {
        ...
        /// <summary>
        /// Publishes a six-payload message to every subscriber on this bus instance, in subscribe order.
        ...
        /// <summary>
        /// Subscribes a handler to a six-payload message on this bus instance.
        /// </summary>
        ...
        private SubscriptionToken SubscribeInternal<TMessage, T1, T2, T3, T4, T5, T6>(Action<T1, T2, T3, T4, T5, T6> handler) where TMessage : IMessage<T1, T2, T3, T4, T5, T6>
        {
            ...
            var freeIndex = Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceFreeListHeads[_instanceId];
            if (freeIndex != NO_FREE_SLOT)
            {
                Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceFreeListHeads[_instanceId] = DecodeNextFree(versions[freeIndex]);

                var reusedVersion = ++Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceVersionCounters[_instanceId];
                handlers[freeIndex] = handler;
                versions[freeIndex] = reusedVersion;

                var reusedToken = new SubscriptionToken(freeIndex, reusedVersion);
#if UNITY_EDITOR || DEVELOPMENT_BUILD
                reusedToken.DebugName = $"{typeof(TMessage).Name}<{typeof(T1).Name},{typeof(T2).Name},{typeof(T3).Name},{typeof(T4).Name},{typeof(T5).Name},{typeof(T6).Name}>";
        ...
        public void Unsubscribe<TMessage, T1, T2, T3, T4, T5, T6>(SubscriptionToken token) where TMessage : IMessage<T1, T2, T3, T4, T5, T6>
        {
            ...
            if (idx >= 0 && idx < Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceCounts[_instanceId])
            {
                if (Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceVersions[_instanceId][idx] == token.Version)
                {
                    ...
                    Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceVersions[_instanceId][idx] = EncodeNextFree(Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceFreeListHeads[_instanceId]);
                    Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceFreeListHeads[_instanceId] = idx;
                }
            }
        }
        ...
        public void Unsubscribe<TMessage, T1, T2, T3, T4, T5, T6>(Action<T1, T2, T3, T4, T5, T6> handler) where TMessage : IMessage<T1, T2, T3, T4, T5, T6>
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    handlers[i] = null;
                    Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceVersions[_instanceId][i] = EncodeNextFree(Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceFreeListHeads[_instanceId]);
                    Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceFreeListHeads[_instanceId] = i;
                    return;
                }
            }
        }
        ...
        /// <summary>
        /// Removes every subscriber for a six-payload message on this bus instance, and resets the
        ...
        public void UnsubscribeAll<TMessage, T1, T2, T3, T4, T5, T6>() where TMessage : IMessage<T1, T2, T3, T4, T5, T6>
        {
            ...
            Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceFreeListHeads[_instanceId] = NO_FREE_SLOT;
        }
        ...
        /// </summary>
        /// <summary>
        /// Returns whether a six-payload message has ever had a subscriber on this bus instance that has
        ...
        public bool HasSubscribers<TMessage, T1, T2, T3, T4, T5, T6>() where TMessage : IMessage<T1, T2, T3, T4, T5, T6>
        {
            ...
            return Storage6<TMessage, T1, T2, T3, T4, T5, T6>.InstanceCounts[_instanceId] > 0;
        }
