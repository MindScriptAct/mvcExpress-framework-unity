// Arity variant 9 of MvcMessageBus - see MvcMessageBus.Params00.cs for the template pattern.
...
namespace mvcExpress.Internal.Messaging
{
    public sealed partial class MvcMessageBus : IMessageBus, IDisposable
    {
        ...
        private void ClearStorage9(Type messageType, Type[] args)
        {
            var storageType = typeof(Storage9<,,,,,,,,,>).MakeGenericType(messageType, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]);
            ClearStorageSlot(storageType);
        }

     // Storage Class for 9 parameters
        private static class Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9> where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        {
            internal static Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>[][] InstanceHandlers = new Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>[4][];
            ...
            internal static void EnsureCapacity(int instanceId)
            {
                ...
                if (InstanceHandlers[instanceId] == null)
                {
                    lock (Lock)
                    {
                        if (InstanceHandlers[instanceId] == null)
                        {
                            InstanceHandlers[instanceId] = new Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>[INITIAL_CAPACITY];
        ...
        /// <summary>
        /// Publishes a nine-payload message to every subscriber on this bus instance, in subscribe order.
        ...
        public void Publish<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9) where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        {
            ...
            ValidateMainThread();
#endif
            if (_instanceId >= Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceHandlers.Length ||
                Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceHandlers[_instanceId] == null)
            {
                return;
            }

            var handlers = Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceHandlers[_instanceId];
            var count = Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceCounts[_instanceId];
        ...
        /// <summary>
        /// Subscribes a handler to a nine-payload message on this bus instance.
        /// </summary>
        ...
        public SubscriptionToken Subscribe<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9> handler) where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        {
            ...
            Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.EnsureCapacity(_instanceId);

#if UNITY_EDITOR || DEVELOPMENT_BUILD
            lock (Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.Lock)
            {
                return SubscribeInternal<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>(handler);
            }
#else
            return SubscribeInternal<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>(handler);
#endif
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private SubscriptionToken SubscribeInternal<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9> handler) where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        {
            var handlers = Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceHandlers[_instanceId];
            var versions = Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceVersions[_instanceId];

            // Reuse a freed slot before growing the array - see the free-list note in MvcMessageBus.cs.
            var freeIndex = Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceFreeListHeads[_instanceId];
            if (freeIndex != NO_FREE_SLOT)
            {
                Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceFreeListHeads[_instanceId] = DecodeNextFree(versions[freeIndex]);

                var reusedVersion = ++Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceVersionCounters[_instanceId];
                handlers[freeIndex] = handler;
                versions[freeIndex] = reusedVersion;

                var reusedToken = new SubscriptionToken(freeIndex, reusedVersion);
#if UNITY_EDITOR || DEVELOPMENT_BUILD
                reusedToken.DebugName = $"{typeof(TMessage).Name}<{typeof(T1).Name},{typeof(T2).Name},{typeof(T3).Name},{typeof(T4).Name},{typeof(T5).Name},{typeof(T6).Name},{typeof(T7).Name},{typeof(T8).Name},{typeof(T9).Name}>";
            ...
            if (count == handlers.Length)
            {
                ...
                var newHandlers = new Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>[newSize];
                var newVersions = new int[newSize];
                Array.Copy(handlers, newHandlers, count);
                Array.Copy(versions, newVersions, count);
                Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceHandlers[_instanceId] = handlers = newHandlers;
                Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceVersions[_instanceId] = versions = newVersions;
            }

            var version = ++Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceVersionCounters[_instanceId];
            handlers[count] = handler;
            versions[count] = version;
            Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceCounts[_instanceId] = count + 1;

            var token = new SubscriptionToken(count, version);

#if UNITY_EDITOR || DEVELOPMENT_BUILD
            token.DebugName = $"{typeof(TMessage).Name}<{typeof(T1).Name},{typeof(T2).Name},{typeof(T3).Name},{typeof(T4).Name},{typeof(T5).Name},{typeof(T6).Name},{typeof(T7).Name},{typeof(T8).Name},{typeof(T9).Name}>";
        ...
        public void Unsubscribe<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>(SubscriptionToken token) where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        {
            ...
            var idx = token.Index;
            if (idx >= 0 && idx < Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceCounts[_instanceId])
            {
                if (Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceVersions[_instanceId][idx] == token.Version)
                {
                    Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceHandlers[_instanceId][idx] = null;
                    Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceVersions[_instanceId][idx] = EncodeNextFree(Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceFreeListHeads[_instanceId]);
                    Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceFreeListHeads[_instanceId] = idx;
                }
            }
        }
        ...
        public void Unsubscribe<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9> handler) where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    handlers[i] = null;
                    Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceVersions[_instanceId][i] = EncodeNextFree(Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceFreeListHeads[_instanceId]);
                    Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceFreeListHeads[_instanceId] = i;
                    return;
                }
            }
        }
        ...
        /// <summary>
        /// Removes every subscriber for a nine-payload message on this bus instance, and resets the
        ...
        public void UnsubscribeAll<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>() where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        {
            ...
            Array.Clear(Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceHandlers[_instanceId], 0, Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceCounts[_instanceId]);
            Array.Clear(Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceVersions[_instanceId], 0, Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceCounts[_instanceId]);
            Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceCounts[_instanceId] = 0;
            Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceFreeListHeads[_instanceId] = NO_FREE_SLOT;
        }
        ...
        /// </summary>
        /// <summary>
        /// Returns whether a nine-payload message has ever had a subscriber on this bus instance that has
        ...
        public bool HasSubscribers<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>() where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        {
            ...
            return Storage9<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9>.InstanceCounts[_instanceId] > 0;
        }
