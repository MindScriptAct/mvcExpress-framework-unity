...
namespace mvcExpress.Internal.Messaging
{
    public sealed partial class MvcMessageBus : IMessageBus, IDisposable
    {
        ...
        /// <summary>
        /// Publishes an eleven-payload message to every subscriber on this bus instance, in subscribe order.
        ...
        /// <summary>
        /// Subscribes a handler to an eleven-payload message on this bus instance.
        /// </summary>
        ...
        private SubscriptionToken SubscribeInternal<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> handler) where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
        {
            ...
            var freeIndex = Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceFreeListHeads[_instanceId];
            if (freeIndex != NO_FREE_SLOT)
            {
                Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceFreeListHeads[_instanceId] = DecodeNextFree(versions[freeIndex]);

                var reusedVersion = ++Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceVersionCounters[_instanceId];
                handlers[freeIndex] = handler;
                versions[freeIndex] = reusedVersion;

                var reusedToken = new SubscriptionToken(freeIndex, reusedVersion);
#if UNITY_EDITOR || DEVELOPMENT_BUILD
                reusedToken.DebugName = $"{typeof(TMessage).Name}<{typeof(T1).Name},{typeof(T2).Name},{typeof(T3).Name},{typeof(T4).Name},{typeof(T5).Name},{typeof(T6).Name},{typeof(T7).Name},{typeof(T8).Name},{typeof(T9).Name},{typeof(T10).Name},{typeof(T11).Name}>";
        ...
        public void Unsubscribe<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(SubscriptionToken token) where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
        {
            ...
            if (idx >= 0 && idx < Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceCounts[_instanceId])
            {
                if (Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceVersions[_instanceId][idx] == token.Version)
                {
                    ...
                    Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceVersions[_instanceId][idx] = EncodeNextFree(Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceFreeListHeads[_instanceId]);
                    Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceFreeListHeads[_instanceId] = idx;
                }
            }
        }
        ...
        public void Unsubscribe<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> handler) where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    handlers[i] = null;
                    Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceVersions[_instanceId][i] = EncodeNextFree(Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceFreeListHeads[_instanceId]);
                    Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceFreeListHeads[_instanceId] = i;
                    return;
                }
            }
        }
        ...
        /// <summary>
        /// Removes every subscriber for an eleven-payload message on this bus instance, and resets the
        ...
        public void UnsubscribeAll<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>() where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
        {
            ...
            Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceFreeListHeads[_instanceId] = NO_FREE_SLOT;
        }
        ...
        /// </summary>
        /// <summary>
        /// Returns whether an eleven-payload message has ever had a subscriber on this bus instance that has
        ...
        public bool HasSubscribers<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>() where TMessage : IMessage<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
        {
            ...
            return Storage11<TMessage, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.InstanceCounts[_instanceId] > 0;
        }
