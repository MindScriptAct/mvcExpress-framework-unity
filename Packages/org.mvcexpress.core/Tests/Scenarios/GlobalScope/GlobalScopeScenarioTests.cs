...
namespace mvcExpress.Tests.Scenarios
{
    ...
    public class GlobalScopeScenarioTests
    {
        ...
        private sealed class RegisterGlobalServiceCommand : Command
        {
            ...
            {
                Global.Register(new GlobalScenarioService(ServiceName)).ToLogic().AsPermanent();
            }
        }
        ...
        private sealed class RegisterGlobalProxyCommand : Command
        {
            ...
            public override void Execute()
            {
                Global.Register(Proxy).ToLogic().AsPermanent();
            }
        }
        ...
        {
            _moduleA.Container.Register(new LocalScenarioService("A-only")).ToLogic().AsPermanent();
