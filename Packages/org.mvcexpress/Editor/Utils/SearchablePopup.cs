...
namespace mvcExpress.Editor.Core
{
    internal static class SearchablePopup
    {
        private sealed class TypeAdvancedDropdown : AdvancedDropdown
        {
            ...
            public TypeAdvancedDropdown(AdvancedDropdownState state, List<Type> types, Action<Type> onSelected)
                : base(state)
            {
            ...
            protected override AdvancedDropdownItem BuildRoot()
            {
                ...
                foreach (var t in _types)
                {
                    ...
                    parent.AddChild(new TypeItem(t));
                }
            ...
            Action<Type> openType)
        {
            ...
            {
                var dd = new TypeAdvancedDropdown(State, types, onSelected);
                dd.Show(rect);
                return true;
            }
