...
namespace mvcExpress
{
    ...
    public sealed class MvcFacade : MonoBehaviour
    {
        ...
        // Registers all plain C# types decorated with [RegisterGlobal] into the global DI container.
        // Called once from InitializeIfNeeded after the Inspector-driven registries have run.
        // MonoBehaviour types were already filtered out at scan time, so every entry here is
        // a plain C# Proxy or service that can be created with Activator.CreateInstance.
