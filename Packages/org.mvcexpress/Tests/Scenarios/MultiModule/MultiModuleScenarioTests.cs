...
namespace mvcExpress.Tests.Scenarios
{
    ...
    public class MultiModuleScenarioTests
    {
        ...
        public void TwoModules_IndependentScopes_ServicesNotShared()
        {
            ...
            _moduleA.Container.Register(serviceA).ToLogic().AsPersistent();
            _moduleB.Container.Register(serviceB).ToLogic().AsPersistent();
        ...
        public void ModuleLifecycle_CreateInitializeDestroy_CleanupComplete()
        {
            ...
            _moduleA.Container.Register(service).ToLogic().AsPersistent();
            _moduleA.Dispose();
            _moduleA = null;

            Assert.That(service.Disposed, Is.True,
                "Disposing a module harness should dispose persistent disposable services registered in its container.");
        }
        ...
        public void ModuleLifecycle_AllActorsDisposedOnModuleDestroy()
        {
            ...
            _moduleA.Container.Register(proxy).ToLogic().AsPersistent();
        ...
        public void InterModuleDependency_ViaGlobalProxy_ResolvedCorrectly()
        {
            ...
            _globalContainer.Register(globalProxy).ToLogic().AsPersistent();
        ...
        public void InterModuleDependency_ViaLocalProxy_NotResolvable()
        {
            ...
            _moduleA.Container.Register(localProxy).ToLogic().AsPersistent();
